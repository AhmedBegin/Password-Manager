...
def EncrypTool():
    ...
    root.iconbitmap('Password key.ico')
    ...
    enc_button = Button(my_frame, text="Encrypt", font=("Helvetica", 18), bg="Red", command=encrypt)
    enc_button.grid(row=0, column=0)

    dec_button = Button(my_frame, text="Decrypt", font=("Helvetica", 18), bg="Green", command=decrypt)
    dec_button.grid(row=0, column=1, padx=20)

    clear_button = Button(my_frame, text="Clear", font=("Helvetica", 18), bg="Grey", command=clear)
